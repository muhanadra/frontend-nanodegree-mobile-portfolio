...
>>>>>>> 83a5a9b5a91eb4f45c403c74a8d82726d1b473d7
  ...
  * Used document.getElementsByClassName instead of querySelectorAll which is slower
  */
  var scrollTop = document.body.scrollTop / 1250;
  var phaseArray = [
    Math.sin(scrollTop + 0) * 100,
    Math.sin(scrollTop + 1) * 100,
    Math.sin(scrollTop + 2) * 100,
    Math.sin(scrollTop + 3) * 100,
...
<<<<<<< HEAD
  ...
  */
  var side = 256; // The width/height of our pizza

  var rows = Math.ceil(window.innerHeight / side);
  var cols = Math.ceil(window.innerWidth / side);

  var numOfPizzas = rows * cols + 1;
...
>>>>>>> 83a5a9b5a91eb4f45c403c74a8d82726d1b473d7
    ...
    elem.basicLeft = (i % cols) * side;
    elem.style.top = (Math.floor(i / cols) * side) + 'px';
